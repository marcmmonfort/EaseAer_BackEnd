...
export class UserController {
  ...
  constructor(private userUseCase: UserUseCase) {
    ...
    this.loginFrontendGoogleUserCtrl =
      this.loginFrontendGoogleUserCtrl.bind(this);
  ...
  public async listFollowersPagCtrl(req: Request, res: Response) {
    ...
    const response = await this.userUseCase.listFollowersPag(
      `${uuid}`,
      `${numPage}`
    );
    res.send(response);
  ...
  public async listFollowedPagCtrl(req: Request, res: Response) {
    const { uuid = "", numPage = "" } = req.params;
    const response = await this.userUseCase.listFollowedPag(
      `${uuid}`,
      `${numPage}`
    );
    res.send(response);
  ...
  public async checkFollowerCtrl({ params }: Request, res: Response) {
    ...
    const response = await this.userUseCase.checkFollower(
      `${uuid}`,
      `${uuidFollowed}`
    );
    res.send(response);
